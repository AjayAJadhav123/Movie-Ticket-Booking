...
export default class AdminErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] bg-[#0a0a0a] p-6">
          <div className="bg-[#141414] p-8 rounded-2xl border border-red-200 shadow-sm max-w-lg w-full text-center">
            ...
            {this.state.error && (
              <div className="bg-slate-800 p-4 rounded-xl text-left overflow-x-auto mb-6 border border-slate-800">
