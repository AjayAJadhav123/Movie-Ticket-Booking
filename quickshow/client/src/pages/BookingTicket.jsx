    ...
    return (
      <div className="min-h-screen pt-20 pb-16 bg-white px-4">
        <div className="container mx-auto">
          ...
          <div className="card border-red-300 bg-red-100 p-6 flex items-start gap-4">
    ...
    <div className="min-h-screen pt-20 pb-16 bg-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          <button
            onClick={handlePrint}
            className="flex items-center justify-center gap-2 px-4 py-2 btn-primary text-sm md:text-base"
          >
            <Printer size={18} />
            Print Ticket
          </button>
        ...
        >
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white p-4 md:p-8">
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-4">
              ...
              <div className="text-right">
                <span className={`inline-block ${statusColor.badge} px-3 md:px-4 py-2 rounded-lg font-bold text-xs md:text-sm border border-current border-opacity-30`}>
          ...
          <div className="p-4 md:p-8">
            ...
            {booking.status === 'confirmed' && (
              <div className="bg-green-50 border border-green-300 rounded-lg p-3 md:p-4 mb-4">
            ...
            {booking.status === 'pending' && (
              <div className="bg-amber-50 border border-amber-300 rounded-lg p-3 md:p-4 mb-4">
            ...
            {booking.status === 'cancelled' && (
              <div className="bg-red-50 border border-red-300 rounded-lg p-3 md:p-4 mb-4">
